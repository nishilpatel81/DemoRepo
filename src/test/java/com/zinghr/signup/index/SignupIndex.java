...
public void displaynameFieldInvalid() throws Exception
{
	...
	log("To verify that appropriate error message is displayed if user enters less than three characters in 'Display Name' field");	
...
public void updateAccountName() throws Exception
{
	...
	signupVerification = signupIndexpage.updateAccountName(emailt,s_company_name,s_display_name,account_name,a_pswd,contact_no);
...
int numOfFailure = 0;		
	...
	signupVerification = signupIndexpage.activateSuccessfully(emailt,s_company_name,s_display_name,account_name,a_pswd,contact_no);
